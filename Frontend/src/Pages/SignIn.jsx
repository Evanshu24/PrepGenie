        ...
        <>
            <div className="min-h-[90vh] flex justify-center items-center">
                <div className="w-[520px] bg-white p-[45px] rounded-[20px] shadow-[0_10px_40px_rgba(9,10,12,0.15)]">
                    ...
                    <h3 className="text-center text-3xl font-bold mb-[15px]">Welcome back</h3>

                    <p className="text-center text-[#666] mb-[35px]">
                        Don't have an account?{" "}
                        <Link to="/signup" className="text-[#2563EB] font-semibold CSS	Tailwind
text-decoration: underline">Sign up</Link>
                    </p>
                    ...
                    <div className="text-end text-decoration: underline mb-4">
